...
async def ctest(_, message):
    ...
    try:
       ...
       if not is_selected:
         ...
         img.paste(img1, (250, 290), img1)
         img.paste(img2, (1620, 300), img2)
...
"""
         ...
         c1_name = (await Michiko.get_users(c1_id)).first_name
         c2_name = (await Michiko.get_users(c2_id)).first_name
